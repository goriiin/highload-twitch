...
1. Легкая бизнес-логика:
   ...
   - RAM: 100 МБайт на каждые 100 пиковых RPS (или 1 МБ / RPS)

2. Средняя бизнес-логика:
	- CPU: 2 ядра на каждые 100 пиковых RPS
 	- RAM: 200 МБайт на каждые 100 пиковых RPS (или 2 МБ / RPS)

3. Тяжелая бизнес-логика:
	- CPU: 5 ядер на каждые 100 пиковых RPS
 	- RAM: 500 МБайт на каждые 100 пиковых RPS (или 5 МБ / RPS)


**Микросервисы**

| Компонент              | Пиковый RPS (оценка) | Сложность / Тип | Базовый CPU (Ядра) | Базовый RAM (ГБ) |
| :--------------------- | :------------------- | :-------------- | :----------------- | :--------------- |
| Сервис Авторизации     | 12                   | Легкая          | 1                  | ~0.1             |
| Сервис Стриминга       | 250K                 | Тяжелая         | 12 500             | 1 220            |
| Сервис Просмотра       | 5M                   | Тяжелая         | 250 000            | 25K              |
| Сервис Пользователя    | 1,340                | Легкая          | 14                 | 2.7              |
| Сервис Поиска          | 4,000                | Легкая          | 40                 | 20               |
| Сервис лент            | 10K                  | Легкая          | 100                | 10               |
| **Итого Микросервисы** | **5.8M**             |                 | **267K**           | ~29K             |

**Базы Данных / Хранилища**

| Компонент                | Пиковый RPS (оценка) | Сложность / Тип      | Базовый CPU (Ядра) | Базовый RAM (ГБ) | Базовый Диск (ТБ) |
| :----------------------- | :------------------- | :------------------- | :----------------- | :--------------- | :---------------- |
| YDB                      | 507,352              | БД (OLTP/Core)       | 5,074              | 400              | 4                 |
...
|                         | RAM          | Ядра CPU    | Диск (ТБ)    |
| :---------------------- | :----------- | :---------- | :----------- |
| **Базовый расчет**      | **~347,973** | **~31,396** | **~502,105** |
| **С ростом и резервом** | **~489,337** | **~44,151** | **~706,103** |
