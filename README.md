...
| **viewers**              | Tarantool | ~1 МБ               | -                                                                                                                                                                        | ПК (`stream_id`)                                                                              | Асинхронная, 5 Реплик<br>master-slave       |
...
| **reactions**            | Tarantool | ~30 МБ              | -                                                                                                                                                                        | - stream_id: HASH                                                                             | Полусинхронная 5 реплик<br>master-slave     |
