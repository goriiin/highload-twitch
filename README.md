...
![image](https://github.com/user-attachments/assets/671b5cb8-a9d6-49e5-a104-e95daf3dcffb)
...
![america](https://github.com/user-attachments/assets/f84c9edd-5704-44be-81bf-55567805a6f0)

![s-am](https://github.com/user-attachments/assets/f8dcadeb-7111-448e-9be2-04a1bb90579a)
...
| № | ЦОД                  | Доля  | средний RPS    | сетевые <br> нагркузки<br> в Гбит/с | 
| - |--------------------- | ---- | -------|------------- | 
...
| Тип запроса      | Доля | RPS       | Время CPU (мс) | Итого CPU (мс/сек) |
| ---------------- | ---- | --------- | -------------- | ------------------ |
| Полный handshake | 30%  | 870,000   | 2 мс           | 1,740,000 мс       |
| Session cache    | 70%  | 2,030,000 | 0.5 мс         | 1,015,000          |
| **Итого:**       | 100% | 2,900,000 | –              | 1,885,000 мс   |

1,885,000 мс=1,885 секунд CPU
