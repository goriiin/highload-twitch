...
| ------------------------------------------------------------------------------------------------------------------- | ---------- | -------- | --------- | ------------ |
| Intel Xeon Silver 4416+ (20 c/40 t) @2.0 GHz, 37.5 MB L3 ([Intel][5]) <br> + 4×16 GB DDR5, Micron 7450 PRO 960GB NVMe U.3 (7mm) 2.5" SSD Drive - PCIe Gen4, 25/10GbE   | **20**     | **64**   | **1.6**     | **25**       |

Цена за сервер €4 580 [^14]. 
...
Подберем на Azure конфигурацию на 1% [^13]. 

При подобной конфигурации оплата в месяц 498 962€ или $5 987 544 в год. Таким образом выгоднее закупать собственное железо.
...
[^13]: https://azure.microsoft.com/ru-ru/pricing/calculator/
[^14]: https://www.broadberry.eu/xeon-scalable-processor-gen4-rackmount-servers/cyberserve-xeon-sp1-102-nvme-g4
